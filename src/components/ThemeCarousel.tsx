...
import {
  ...
  FlaskConical,
  MessageCircle,
  Dog,           // Ajout : icône domaine vétérinaire
  Syringe,       // Ajout : icône dispositif (glucomètre)
} from "lucide-react";
...
const themes = [
  ...
  },
  {
    ...
    icon: Dog, // Icône vétérinaire adaptée
    color: "text-gray-800",
    bgColor: "bg-gray-50",
    borderColor: "border-gray-200",
  },
  {
    ...
    icon: Syringe, // Icône suggérant un dispositif médical (glucomètre)
    color: "text-gray-800",
    bgColor: "bg-gray-50",
    borderColor: "border-gray-200",
  },
